...
The <b>NullomersAssessor.py</b> script (which can be downloaded directly from this repository) requires 2 input files. The first one should be fasta-formatted file containing the entire genome/proteome of a species. The second file should be a list of nullomers. Tools such as <b>[MAW](https://github.com/solonas13/maw)</b> or <b>[em-MAW](https://github.com/solonas13/maw/tree/master/em-maw)</b> can be used for the calculation of globally missing sequences in an organism. The previously mentioned tools require a specific one-line with one-header format. This format can be easily created using the <b>OneHeaderFastaFormatter.py</b> script. Please find out more information on how to run the preparatory steps in the detailed [user guide](https://www.nullomers.org/Documentation_NullomersAssessor) of <b>Nullomers Database</b>.
