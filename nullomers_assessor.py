...
charge_table = { ############## '*' = neutral, '-' = negative charge, '+' = positive charge - not used in the current version  ##############
    'A': ('*'),
    'C': ('*'),
    'D': ('-'),
    'E': ('-'),
...
polarity_table = { ############## '-' = non polar, '+' = polar - not used in the current version  ##############
    'A': ('-'),
    'C': ('+'),
    'D': ('+'),
    'E': ('+'),
...
title = "\n***** Nullomers Assessor: Statistical evaluation of nullomers' significance (version 1.00) *****\n"
print(title)
...
#####################
    ...
    elif (correction_method == 'TARONE'): ##adjusted benjamini-hochberg method
        print("- The selected correction method is: " + str(correction_method) + "")
        print("- The q-value threshold is: " + str(threshold) + "\n")
